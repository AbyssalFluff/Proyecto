...
def huella_agua():
    ...
    lb_info4=tk.Label(pagina_huellaAgua, text="Cuanto combustible(en litros) ",
                  width=23, height=1, font=("Arial", 12), bg="white")
    area_trabajo.create_window(122,140,window=lb_info4)
    lb_info5=tk.Label(pagina_huellaAgua, text="consume tu carro por kilómetro:",
                  width=26, height=1, font=("Arial", 12), bg="white")
    area_trabajo.create_window(128,160,window=lb_info5)
    txt_combustible=tk.Entry(pagina_huellaAgua, font=("Arial", 12), width=18)
    area_trabajo.create_window(360,150,window=txt_combustible)
    
    #Boton para calcular la huella
    catch_btn=tk.Button(pagina_huellaAgua, text="Calcular huella", command=calcular_huella,
    ...
    view_btn=tk.Button(pagina_huellaAgua, text="Ver huellas", command=ver_huellas,
                           bg="light grey", width=15, height=1, font=("Arial", 12))
    area_trabajo.create_window(330,220,window=view_btn)

    #Boton para buscar un calculo
    search_btn=tk.Button(pagina_huellaAgua, text="Buscar huella", command=buscar_huella,
                           bg="light grey", width=15, height=1, font=("Arial", 12))
    area_trabajo.create_window(330,280,window=search_btn)

    #Boton para eliminar un calculo
    release_btn=tk.Button(pagina_huellaAgua, text="Eliminar huella", command=eliminar_huella,
                           bg="light grey", width=15, height=1, font=("Arial", 12))
