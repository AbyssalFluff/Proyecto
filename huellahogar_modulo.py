...
def huella_energia():
    ...
    lb_info1=tk.Label(pagina_huellacasas, text="Aqui puedes calcular la huella de carbono de tu carro.",
    ...
    lb_info4=tk.Label(pagina_huellacasas, text="Cuanto Energia(en litros) ",
                  width=23, height=1, font=("Arial", 12), bg="white")
    area_trabajo.create_window(122,140,window=lb_info4)
    lb_info5=tk.Label(pagina_huellacasas, text="consume tu carro por kilómetro:",
